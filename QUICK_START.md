...
6. Add redirects for EVERY place you run the bot (Google checks them
   byte for byte against YOUTUBE_REDIRECT_URI — https, no trailing slash):
     http://localhost:8080/oauth/youtube/callback
     https://<your-service>.up.railway.app/oauth/youtube/callback
